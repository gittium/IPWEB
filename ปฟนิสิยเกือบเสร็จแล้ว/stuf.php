...
<body>
    ...
    <div class="container">
        ...
        <section class="skills">
            ...
            <textarea class="text_edit" id="skills_text_edit" style="display:none;"><?php echo htmlspecialchars($student['skills_list'], ENT_QUOTES, 'UTF-8'); ?></textarea>
        </section>

        <h3>Interest</h3>
        <section class="interest">
            <p id="interest_text_display"><?php echo htmlspecialchars($student['interest_list'], ENT_QUOTES, 'UTF-8'); ?></p>
            <textarea class="text_edit" id="interest_text_edit" style="display:none;"><?php echo htmlspecialchars($student['interest_list'], ENT_QUOTES, 'UTF-8'); ?></textarea>
        </section>
    ...
    <script>
        function toggleEdit() {
    const textSections = ['skills', 'interest', 'about'];

    textSections.forEach(section => {
        const displayElement = document.getElementById(`${section}_text_display`);
        const editElement = document.getElementById(`${section}_text_edit`);
...
function saveChanges() {
    ...
    xhr.send("skills_text=" + encodeURIComponent(skillsText) +
