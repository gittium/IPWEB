...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($jobpost_title && $jobpost_reward_id && $jobpost_descriptions) {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('New job posted successfully'); window.location='jobpost.html';</script>";
        } else {
        ...
        <div class="form-card">
            ...
            <form method="POST" action="jobpost.php">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" id="job-name" name="created_at" placeholder="">
                </div>
