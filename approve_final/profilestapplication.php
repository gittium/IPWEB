...
$user_id = $student_id;
$_SESSION['user_id'] = $user_id; //  ⭐ ส่งค่าผ่าน session เพื่อให้ calculate_review ใช้ค่านี้
if (!$student_id) {
        ...
        <div class="content">
            <div class="detail-head">
                <a href="review.php?student_id=<?php echo urlencode($student_id); ?>">
                    <div class="review">
                        <div class="rating bg-sumary"><?php echo number_format($calculation['group_avg_rating'], 1); ?>
                        </div>
